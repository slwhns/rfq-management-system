                            ...
                            <tr style="border-bottom:1px solid #ececec;">
                                ...
                                <td style="padding:10px 8px; text-align:center;">
                                    ...
                                    <div class="d-flex ai-center jc-center" style="gap:8px; flex-wrap:wrap;">
                                        <select class="quote-status-select pd-5 bdr-all-22 br-5 fs-12" data-quote-id="{{ $quote->id }}" data-prev-status="{{ $normalizedStatus }}" style="border: 1px solid #d9d9d9; background: #ffffff; color: #222222; min-width: 132px;" {{ $isDeclinedStatus ? 'disabled' : '' }}>
                                            @if(!$canSelectCurrent && !$isDeclinedStatus)
                                ...
                                <td style="padding:10px 8px;">
                                    <div class="d-flex" style="flex-direction:column; gap:6px;">
                                        <div class="mg-b-4 pd-8 br-5" style="background:#f8f9fb; border:1px solid #e2e6ef;">
                                            ...
                                            @if(!empty($quote->admin_notes))
                                                ...
                                                @if($quote->admin_notes_updated_at)
                                                    <div class="fs-11 clr-grey1 mg-t-5">Updated: {{ optional($quote->admin_notes_updated_at)->format('d M Y, h:i A') }}</div>
                                                @endif
                                            @else
                                        ...
                                        @if($quote->staff_response_updated_at)
                                            <div class="fs-11 clr-grey1">Response updated: {{ optional($quote->staff_response_updated_at)->format('d M Y, h:i A') }}</div>
                                        @endif
                                    </div>
                                </td>
                                <td style="padding:10px 8px; text-align:center;">
